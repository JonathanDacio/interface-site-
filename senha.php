    ...
    <div class="container">
        <form autocomplete="off">
            ...
            <div class="input-section">
                <label>Token <span class="required-color">*</span></label>
                <input type="email" placeholder="Informe seu Token" id="email" name= "email" required />
            ...
            <div class="input-section">
                ...
                <input type="email" placeholder="Informe uma nova senha" id="email" name= "email" required />
                <span id="email-error" class="hide required-color error-message">Email inválido</span>
                <span id="empty-email" class="hide required-color error-message">Campo obrigatório</span>
            </div>

            <div class="input-section">
                <label>Confirmar senha<span class="required-color">*</span></label>
                <input type="password" placeholder="Confirme senha" id="password" name= "senha" required />
            ...
            <button id="submit-button">Confirmar senha </button>
        </form>
